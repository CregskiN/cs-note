...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        for (unsigned int i = 0; i < 10; i++) {
            ...
            cubeShader.setVec3("light.position", cameraPosition);
            ...
            cubeShader.setFloat("light.k_constant", 1.0f);
            cubeShader.setFloat("light.k_linear", 0.09f);
            cubeShader.setFloat("light.k_quadratic", 0.032f);
            cubeShader.setVec3("light.direction", cameraFront);
            cubeShader.setFloat("light.cos_cutOff", glm::cos(glm::radians(12.5f)));
            cubeShader.setFloat("light.cos_outerCutOff", glm::cos(glm::radians(17.5f)));
            // cubeShader.setVec3();
            // cubeShader.setFloat();
